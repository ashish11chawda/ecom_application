...
public class UserService {
    ...
    public void addUser(UserRequest userRequest) {
        User user = new User();
        mapUserFromRequest(userRequest, user);
    ...
    private void mapUserFromRequest(UserRequest userRequest, User user) {
        user.setFirstName(userRequest.getFirstName());
        user.setLastName(userRequest.getLastName());
        user.setEmail(userRequest.getEmail());
        user.setPhone(userRequest.getPhone());
        if (userRequest.getAddress() != null) {
            Address address = mapAddressFromUserRequest(userRequest);
            user.setAddress(address);
        }
    }

    private Address mapAddressFromUserRequest(UserRequest userRequest) {
